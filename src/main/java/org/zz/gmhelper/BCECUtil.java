...
public class BCECUtil {
    ...
    public static ECPublicKeyParameters createECPublicKeyParameters(byte[] encodedPubKey, ECCurve curve,
            ECDomainParameters domainParameters) {
        return new ECPublicKeyParameters(curve.decodePoint(encodedPubKey), domainParameters);
    }
    ...
    public static X962Parameters getDomainParametersFromName(java.security.spec.ECParameterSpec ecSpec,
        ...
        if (ecSpec instanceof ECNamedCurveSpec) {
            ASN1ObjectIdentifier curveOid = ECUtil
                    .getNamedCurveOid(((ECNamedCurveSpec) ecSpec).getName());
            if (curveOid == null) {
